...
namespace gcgcg
{
    class Mundo : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //objetoNovo.PontosAdicionar(new Ponto4D(100, 100));
            //objetoNovo.PontosAdicionar(new Ponto4D(100, 400));
            //objetoNovo.PontosAdicionar(new Ponto4D(400, 400));
            //objetoNovo.PontosAdicionar(new Ponto4D(400, 100));

            //objetoNovo = null;

            //Slime slime = new Slime("Slimes", null, ponto1, ponto2, ponto3, ponto4);
            //retangulo.FilhoAdicionar(slime);
            //objetosLista.Add(slime);
